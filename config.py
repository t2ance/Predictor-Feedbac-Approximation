...
def get_config(system_, n_iteration=None, duration=None, delay=None):
    if system_ == 's1':
        ...
        dataset_config = DatasetConfig(recreate_training_dataset=True, data_generation_strategy='trajectory',
                                       delay=1, duration=32, dt=0.05, n_dataset=200, n_sample_per_dataset=-1,
        ...
        train_config = TrainConfig(learning_rate=5e-3, training_ratio=0.8, n_epoch=2000, batch_size=64,
