...
def get_config(system_, n_iteration=None, duration=None, delay=None):
    if system_ == 's1':
        ...
        train_config = TrainConfig(learning_rate=1e-3, training_ratio=0.8, n_epoch=700, batch_size=64,
        ...
        dataset_config = DatasetConfig(recreate_training_dataset=True, data_generation_strategy='trajectory', delay=.5,
                                       # duration=8, dt=0.05, n_dataset=250, n_sample_per_dataset=-1, n_plot_sample=20,
                                       duration=8, dt=0.02, n_dataset=500, n_sample_per_dataset=-1, n_plot_sample=20,
        ...
        train_config = TrainConfig(learning_rate=3e-5, training_ratio=0.8, n_epoch=750, batch_size=128,
